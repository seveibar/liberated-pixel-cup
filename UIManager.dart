class UIManager {
  ...
  UIManager(){
    ...
    final num CANVAS_OFFX = (html.window.innerWidth - canvas.width)/2;
    final num CANVAS_OFFY = 100;
    ...
    if (!MOBILE){
      ...
      html.window.on.mouseDown.add((e){
        mouseDownAt((e.pageX - CANVAS_OFFX) / RESOLUTION,(e.pageY - CANVAS_OFFY)/RESOLUTION);
      ...
      html.window.on.mouseUp.add((e){
        mouseUpAt((e.pageX - CANVAS_OFFX) / RESOLUTION,(e.pageY - CANVAS_OFFY)/RESOLUTION);
      });
      html.window.on.mouseMove.add((e){
        mouseAt((e.pageX - CANVAS_OFFX) / RESOLUTION,(e.pageY - CANVAS_OFFY)/RESOLUTION);
      });
    }else{
